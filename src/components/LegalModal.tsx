...
const privacyText = `
**Privacy Policy — Hum Technologies Pvt. Ltd.**

Last updated: January 1, 2025

Hum Technologies Pvt. Ltd. ("Hum", "we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your personal information when you use our products and services.
...
For KAVACH AI users with local server deployment, monitoring data is stored on-premises within your institution's infrastructure. Cloud-hosted data is stored securely using industry-standard encryption.
...
We are committed to protecting student data. All student activity data collected through KAVACH AI is accessible only to authorized school administrators, IT staff, and (where enabled) parents/guardians.

**6. Your Rights**
You have the right to access, correct, or delete your personal data. Contact us at privacy@humtech.in to exercise these rights.

**7. Contact Us**
For privacy-related questions, email privacy@humtech.in or write to our registered office.
`;

const termsText = `
**Terms of Use — Hum Technologies Pvt. Ltd.**

Last updated: January 1, 2025

These Terms of Use govern your access to and use of the products and services provided by Hum Technologies Pvt. Ltd.
...
Hum provides AI-powered software products for institutions, including KAVACH AI for computer lab monitoring and student safety. Products are licensed, not sold.
...
All content, features, and functionality of our products are owned by Hum Technologies and protected by intellectual property laws.

**7. Limitation of Liability**
To the maximum extent permitted by law, Hum shall not be liable for any indirect, incidental, or consequential damages arising from your use of our products.
...
**10. Contact**
For questions about these Terms, email legal@humtech.in.
`;
